...
class UserServiceTest {
    ...
    void getUserByIdTest() {
        long userId = 1;
        User expected = new IUser(userId, "user1", "user1@gmail.com");
    ...
    void getUsersByEmailTest() {
        ...
        User expected = new IUser(1, "user1", email);
    ...
    void getUsersByNameTest() {
        String name = "user1";
        User expected = new IUser(1, name, "user1@gmail.com");
    ...
    @Test
    void createUserTest() {
        User expected = new IUser(1, "user1", "user1@gmail.com");
    ...
    @Test
    void updateUserTest() {
        User expected = new IUser(1, "user", "user@gmail.com");
